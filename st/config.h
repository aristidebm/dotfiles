...
static char *font = "JetBrainsMono Nerd Font Mono:style=Medium:pixelsize=24:antialias=true:autohint=true";
// static char *font = "VictorMono Nerd Font Mono:style=Medium:pixelsize=20:antialias=true:autohint=true";
// static char *font = "Liberation Mono:pixelsize=12:antialias=true:autohint=true";

// Add an interesting padding, the default of 2 is too small
