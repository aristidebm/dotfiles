...
Auto-Org configuration file for better startup times, it refreshes the package-quickstart file.
...
Add support for (neo)vim `gc` commands for commentings lines and regions.
...
Add support tpope's vim-surround keybindings to evil mode.
...
Don't forget to remove org-superstar if you want to use it. To Learn more about Org, you can [[V][Tutorials]]
Or [[V][The Official Org Mode Manual]]
...
#+RESULTS:
| org-tempo-setup | org-modern-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | toc-org-mode | org-indent-mode | #[nil ((add-hook 'after-save-hook #'start/org-babel-tangle-config)) (t)] |
...
**** Org Modern
Prettify headings and plain lists in Org mode. Modern version of org-superstar.
#+begin_src emacs-lisp
...
**** Org Pandoc
Use Pandoc to have proper document export
#+begin_src emacs-lisp
